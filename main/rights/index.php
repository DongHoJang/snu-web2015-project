    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="resources/알바AZ.png" alt="First slide"/>
          <div class="container">
            <div class="carousel-caption">
              <h1>Pamoon 15th Audition!</h1>
              <p>We recruit <code> : Male Vocal / Female Vocal / bass  </code></p>
              <p><code> Guitar 1 / Guitar 2 / Bass / Drum / Keyboard </code></p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Apply for today</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="second-slide" src="resources/test.jpg" alt="Second slide"/>
          <div class="container">
            <div class="carousel-caption">
              <h1>We are Pamoon Rangers!</h1>
              <p> Are you ready for Jump? at Freshman Membership Training Camp, I heard a rumor - Ki-Ha & faces</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Learn more</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="third-slide" src="resources/알바AZ.png" alt="Third slide"/>
          <div class="container">
            <div class="carousel-caption">
              <h1>Pamoon's 35th Concert</h1>
              <p>We had a awesome concert. At SoundMind in NakSungDae!</p>
...
<div class="container" id="main">
   ...
   <div class="col-md-4 col-sm-6">
        <a href="권리장전1.html"><div class="panel panel-default">
          <div class="panel-heading"><h4>아르바이트 청년의 권리</h4></div>
   			<div class="panel-body">
              <div class="list-group">
                <img src="resources/test.jpg" class="img-responsive" alt="Responsive image">
              </div>
            </div>
   		</div></a>
        ...
        <div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>청소년 알바권리장전</h4></div>
   			<div class="panel-body">
              <img src="//placehold.it/150x150" class="img-circle pull-right"> <a href="#">청소년 알바권리장전</a>
              <div class="clearfix"></div>
              우리는 이 사회에서 청년들이 보편적 인권의 관점에서 인간다운 삶을 향유 할 수 있도록, 일터에서 차별받지않고 정당한 임금 및 대우를 받으며, 쾌적하고 안전한 근로환경 속에서 노동의 소중한 가치를 깨닫고 자아를 성취할 수 있도록 이 권리장전을 선언한다.
              <hr>
  	...
  	<div class="col-md-4 col-sm-6">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>알바권리장전</h4></div>
        <div class="panel-body">
              <div class="list-group">
                <a href="http://bootply.com/tagged/bootstrap-3" class="list-group-item active">아르바이트 청년의 권리</a>
                <a href="http://bootply.com/tagged/snippets" class="list-group-item">사용자의 의무</a>
                <a href="http://bootply.com/tagged/example" class="list-group-item">노동부의 의무</a>
              </div>
            </div>
      </div>
        ...
        <div class="panel-body">
          ...
          <div class="well"> 
           ...
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Portlet Heading</h4></div>
   			<div class="panel-body">
          <video class="featurette-image img-responsive center-block" data-src="holder.js/500x500/auto" alt="Generic placeholder image" width="500" height="500" controls>
            <source src="resources/PM150214.mp4" type="video/mp4">
            <source src="resources/PM150214.mp4" type="video/ogg">
  	...
  	<div class="col-md-4 col-sm-6">
         <div class="panel panel-default">
           <div class="panel-heading"><a href="#"><h4>사용자의 의무</h4></div>
   			<div class="panel-body">
              <img src="resources/3단계.jpg" class="img-responsive" alt="Responsive image">
            </div>
   		</div></a> 
